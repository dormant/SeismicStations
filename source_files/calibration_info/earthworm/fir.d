...
MaxGap              2           # Maximum gap, in sample periods, allowed
...
Band 0.0 0.02 0 0.005
Band 0.04 1.0 1 0.005
#Band 0.04 0.2 1 0.005
#Band 0.5 1.0 0 0.005
...
#
#         IN-SCNL        OUT-SCNL
#GetSCNL MBGB BHZ MV -- MBGB SHZ MV --
GetSCNL MBRY BHZ MV -- MBRY SHZ MV --
GetSCNL MBRV BHZ MV -- MBRV SHZ MV --
GetSCNL MBWH BHZ MV -- MBWH SHZ MV --

GetSCNL SVB HHZ TR --  SVB EHZ TR 00
GetSCNL SVT HHZ TR --  SVT EHZ TR 00
GetSCNL SVGT HHZ TR --  SVGT EHZ TR 00
#GetSCNL SVV HHZ TR --  SVV EHZ TR --

# Filter regional stations (Dominica), RCS 18-Jun-2019
#GetSCNL DSLB HHZ TR -- DSLB SHZ TR --
#GetSCNL MDN HHZ TR -- MDN SHZ TR --
#GetSCNL DWS HHZ TR -- DWS SHZ TR --
#GetSCNL DLPL HHZ TR -- DLPL SHZ TR --
